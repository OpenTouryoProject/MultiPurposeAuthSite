...
xcopy /E /Y /I "OpenTouryo\root\programs\CS\Frameworks\Infrastructure\Build_netcore60" "MultiPurposeAuthSite\root\programs\OpenTouryoAssemblies\Build_netcore60\"