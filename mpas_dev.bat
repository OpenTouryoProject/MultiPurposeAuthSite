...
xcopy /E /Y /I "OpenTouryo\root\programs\CS\Frameworks\Infrastructure\Build_netcore100" "MultiPurposeAuthSite\root\programs\OpenTouryoAssemblies\Build_netcore100\"
