    ...
    public abstract class MyApsBaseLogic : BaseLogic
    {
            ...
            DbEnum.IsolationLevelEnum iso)
        {
            ...
            else
            {
                ...
                //    damABT = new DamOraOdp();
                //    damAMT = new DamOraOdp();
                ...
                if (damABT != null && damAMT != null)
                {
                    ...
                    this.SetDam(this._damKeyforAMT, damAMT);
                }
            }
